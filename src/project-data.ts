...
export type Project = {
  ...
  rubric?: RubricBand[];
  /** How the grade is made up; shown under the rubric. Line breaks separate paragraphs. */
  assessment?: string;
...
export const defaultProjects: Project[] = [
  ...
  },
  {
    ...
    intro: "Hópverkefni sem dregur saman Verk 3–6. Hópurinn hannar autt rými sem verkstæði, verðleggur búnaðinn á netinu, smíðar merkiljósarás og skilar verkinu á þrjá vegu: PDF-skýrslu, snyrtilegri zip-möppu og kynningu mánudaginn 21. september. Verkefnið er eitt og einkunnin ræðst af því hversu vel er vandað til verksins.",
    tools: "Teikniforritið úr Verk 3 eða rúðustrikað blað · Excel eða Google Sheets · Falstad (falstad.com/circuit) · Word eða Google Docs fyrir PDF · PowerPoint, Google Slides eða Canva · vefverslanir: byko.is, husa.is, bauhaus.is, elko.is, ikea.is",
    ai: "AI 1 — AI má hjálpa við orðalag. Tölur, verð og rásin sjálf þurfa að vera ykkar eigin og sannreynd.",
    canvasId: 24134,
    group: true,
    scenario: "Hópurinn fær autt rými og á að gera það að nothæfu verkstæði sem nýtist pípara, smið og rafvirkja jafnt. Hóparnir, fjórir til fimm í hverjum, eru ákveðnir af kennara og birtir í Canvas. Veljið eitt rými:\nA · Lítil stofa, 4 × 5 m, ein hurð og einn gluggi.\nB · Bílskúr, 6 × 8 m, bílskúrshurð og ein gönguhurð, enginn gluggi.\nC · Langt herbergi, 3 × 9 m, hurð á enda og tveir gluggar á langvegg.\nTímalína: Mánudaginn 14. september er kennslustundin, 100 mínútur, ætluð í sjálfa vinnuna. Skiptið verkum strax og klárið grunnmynd, innkaupalista og rás þann dag. Þriðjudaginn 15. september fara allir hópar til Halla í stofu 312 í myndatöku. Mánudaginn 21. september er skilað og kynnt, og eftir kynningarnar fyllir hver og einn út jafningjamat í Canvas.",
    submission: "Einn úr hópnum skilar þremur skrám í Canvas, og hver þeirra sýnir allt verk hópsins:\n1 · PDF-skýrsla, uppsett eins og myndaskýrslan í Verk 5: forsíða með hópmynd og nöfnum, ábyrgðartafla, grunnmynd, innkaupalisti með samtölum og skjámynd af rásinni, með myndatexta við hverja mynd.\n2 · Zip-skrá með öllum vinnuskjölum hópsins í snyrtilegum möppum með lýsandi heitum.\n3 · Kynningin, sem PowerPoint-, Keynote- eða PDF-skrá, eða hlekkur á Google Slides eða Canva.\nSetjið hlekk á reiknisskjalið, opið fyrir alla með hlekk, í athugasemd við skilin. Skilið fyrir kynninguna 21. september. Jafningjamatinu skilar hver og einn sérstaklega í Canvas eftir kynningarnar.",
    rubric: [
      { grade: "5–6", title: "Allt skilað", text: "Öll skrefin eru gerð og skilað í öllum þremur myndum: PDF, zip og kynning. Innihaldið er rétt en frágangur er lágmark." },
      { grade: "7–8", title: "Vel unnið", text: "Allt lítur vel út. PDF-skýrslan er snyrtileg og læsileg, zip-mappan er skipulögð með góðum heitum, glærurnar eru auðlesnar og kynningin er skýr og innan tíma." },
      { grade: "9–10", title: "Umfram það sem beðið var um", text: "Hópurinn lagði meira í verkið: fallegri grunnmynd með fleiri smáatriðum, flóknari eða áhugaverðari rafrás, hreyfingar eða myndefni í glærunum, PDF sem lítur út eins og frá fagfyrirtæki, verð borin saman milli verslana." },
    ],
    assessment: "Einkunnin fyrir Verk 7 er í tveimur jöfnum hlutum. Helmingurinn er hópeinkunn fyrir skilin og kynninguna, samkvæmt töflunni hér fyrir ofan, og hún er sú sama fyrir alla í hópnum. Hinn helmingurinn er einkunn kennara fyrir hvern og einn: hvernig kennarar sáu þig vinna í tímum, hvort þú tókst þátt, hjálpaðir til og kláraðir það sem þú barst ábyrgð á.\nJafningjamatið og sjálfsmatið er skylda fyrir alla og er ykkar rödd í seinni helmingnum. Þar segið þið kennurum hvað hver og einn gerði, líka það sem kennarar sáu ekki. Þið fyllið það út í Canvas, í „Jafningjamat Verk 7“, eftir kynningarnar mánudaginn 21. september. Það gefur 0 stig sjálft, en verkinu er ekki lokið fyrr en það er komið inn.",
    levels: [
      { key: "easy", label: "Verkefnið", kicker: "Tíu skref", points: 10, task: "Gerið öll tíu skrefin. Hakið við jafnóðum. Hversu vel þið vandið hvert skref ræður einkunninni.", steps: [
        ...
        { text: "Reiknið flatarmál rýmisins og heildarkostnað með 10% viðbót fyrir ófyrirséð.", hint: "Flatarmál = lengd × breidd. Samtala = SUM af verðdálkinum. Viðbót = samtala × 0,1. Heild = samtala + viðbót. Notið formúlur svo tölurnar uppfærist sjálfkrafa ef verð breytist. Sýnið allar þrjár tölurnar í skýrslunni." },
        { text: "Smíðið merkiljósarás í Falstad: 9 V rafhlaða, rofi, viðnám og LED sem logar þegar rofinn er á. Takið skjámynd þar sem ljósið logar.", hint: "Þetta er ljósið við hurðina sem sýnir að verkstæðið sé upptekið. Sama rás og í Verk 4. Byrjið með 470 Ω viðnám; ef LED-ið brennur yfir í herminum er viðnámið of lítið. Merkið íhlutina og gildin á myndinni. Viljið þið meira: bætið við öðru ljósi, hljóðgjafa eða skynjara.", link: { label: "Verk 4 · Stafræn rafrás í Canvas", url: "https://canvas.tskoli.is/courses/1907/assignments/24133" } },
        ...
        { text: "Búið til kynningu sem sýnir allt verkið og flytjið hana á 3–4 mínútum mánudaginn 21. september. Allir í hópnum tala og geta svarað spurningu.", hint: "PowerPoint, Google Slides, Canva eða Keynote, að eigin vali. Fjórir hlutar: rýmið, kostnaðurinn, rásin, hvað við lærðum. Ein mynd og fáar setningar á hverri glæru, ekki upplestur. Æfið einu sinni með tíma. Kynningin er metin í tíma." },
        { text: "Fyllið út jafningjamat og sjálfsmat í Canvas eftir kynningarnar mánudaginn 21. september. Hver og einn gerir þetta fyrir sig.", hint: "Opnið „Jafningjamat Verk 7“ í Canvas. Þið metið ykkur sjálf og alla í hópnum og rökstyðjið stutt: hvað gerði hver og einn? Þetta er ykkar rödd í einkunn kennara, sjá Einkunn hér fyrir neðan. Aðeins kennarar sjá svörin." },
      ], deliverable: "PDF-skýrsla, zip-skrá og kynning sem allar sýna allt verk hópsins, með hópmynd, ábyrgðartöflu, grunnmynd með málum, innkaupalista með átta verðum og heild með 10% viðbót og skjámynd af logandi LED-rás. Hlekkur á reiknisskjalið í athugasemd. Allir með nýja prófílmynd í Innu og Canvas og jafningjamat skilað." },
    ],
  },
  {
    number: 9,
