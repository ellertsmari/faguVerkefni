...
export const defaultProjects: Project[] = [
  ...
  },
  {
    ...
    overview: [
      ...
      { label: "Vinnudagar", value: "Þri 15. og mán 21. sept." },
      { label: "Skráaskil", value: "Í lok tímans 21. sept. · í síðasta lagi kl. 23:59" },
    ...
    levels: [
      { key: "easy", label: "Vinnuáætlun og gátlistar", kicker: "Sjö áfangar · hakið við jafnóðum", points: 10, task: "Skilið PDF-skýrslu, zip-möppu með vinnuskjölum og glærusýningu um verkstæðið ykkar og kynnið það fyrir bekknum. Áfangar 4–6 eru gátlistar yfir það sem þarf að vera í hverri skrá.", steps: [
        ...
        { phase: "3 · Stoppið og athugið stöðuna", text: "Seinni vinnudagurinn er mánudaginn 21. september. Þegar um 50 mínútur eru eftir af þeim tíma: hættið að bæta við, farið saman yfir gátlistana þrjá hér fyrir neðan og gerið skrárnar þrjár tilbúnar. Markmiðið er að skila í lok tímans. Skilafrestur rennur út kl. 23:59 sama dag.", hint: "Þetta er mikilvægasta stopp verkefnisins. Fimmtíu mínútur duga til að setja saman PDF, zip-möppu og glæruskrá og prófa þær, en ekki til að vinna nýja hluta. Hópar sem eru búnir fyrr mega skila strax, líka 15. september. Það sem vantar á milli vinnudaganna má vinna heima í sameiginlegu vinnumöppunni." },
        ...
        { phase: "7 · Skil, kynning og mat", text: "Einn úr hópnum skilar öllum þremur skránum saman í Canvas, helst í lok tímans mánudaginn 21. september og í síðasta lagi kl. 23:59 sama dag. Sjá „Áður en þið skilið“ hér fyrir neðan.", hint: "Við endurskil þurfa allar þrjár skrárnar að fylgja aftur. Athugið staðfestinguna frá Canvas." },
